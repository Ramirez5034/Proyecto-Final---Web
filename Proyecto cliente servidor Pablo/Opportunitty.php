...
//------------------------------------------------------------------------------------------------------
$consulta = "SELECT * FROM opportunity WHERE status = 1";
$datos = $conn->query($consulta);
echo '<table class="table">';
echo "<tr>";
echo "<th><p>Number</th></p>";
echo "<th><p>Name</th></p>";
...
while ($registro = $datos->fetch_assoc()) {
    echo '
            <tr>           
                ...
                <td>' . $registro["Name"] . '</td>
                <td><a href="FormUpdOpportunitty.php?OpportunityID=' . $registro["OpportunityID"] . '"><i class="bi bi-pencil-square"></i></td>
                <td><a href="DelOpportunitty.php?OpportunityID=' . $registro["OpportunityID"] . '" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este registro?\')">
                <i class="bi bi-trash-fill"></i>';
    echo "</tr>";
}
echo "</table>";

echo '<td><a href="ForminserOpportunity.html"><i class="bi bi-plus-square"></i>';
